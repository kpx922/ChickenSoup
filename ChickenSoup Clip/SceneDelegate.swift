...
//  ChickenSoup Clip
//
//  Created by Shihchiao Chao on 7/4/20.
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        quoteViewController.quotationsType = Quotations.type.soupOfTheDay
        quoteViewController.backgroundNumber = Int.random(in: 0..<20)
